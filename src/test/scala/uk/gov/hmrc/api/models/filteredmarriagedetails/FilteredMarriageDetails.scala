...
package uk.gov.hmrc.api.models.filteredmarriagedetails
...
object FilteredMarriageDetailsItem {
  implicit val format: Format[FilteredMarriageDetailsItem] = Json.format[FilteredMarriageDetailsItem]
}
...
object FilteredMarriageDetails {
  implicit val format: Format[FilteredMarriageDetails] = Json.format[FilteredMarriageDetails]
}
