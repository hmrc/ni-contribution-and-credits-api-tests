...
class ErrorValidation_BackendResponses extends BaseSpec {
  Feature("VALIDATION OF ERROR CODES FOR BACKEND RESPONSES") {
    ...
    Scenario("Request receives 500 error response from backend in response to 400"){
      val response =
        niccService.makeRequest(Request("BB000400", "1960-04-05", Some("e470d658-99f7-4292-a4a1-ed12c72f1337"), "1970", "2019"))
    ...
    Scenario("Request receives 500 error response from backend in response to 400A"){
      val response =
        niccService.makeRequest(Request("BB000400A", "1960-04-05", Some("e470d658-99f7-4292-a4a1-ed12c72f1337"), "1970", "2019"))
    ...
    Scenario("Request receives 500 error response from backend in response to 400B"){
      val response =
        niccService.makeRequest(Request("BB000500", "1960-04-05", Some("e470d658-99f7-4292-a4a1-ed12c72f1337"), "1970", "2019"))
      response.status shouldBe 500
      println("Response Status Code is : " + response.status + " " + response.statusText)
      response.body shouldBe ""
      println("Response Body is: " + response.body)
    ...
    Scenario("Request receives 422 error response from backend"){
      val response =
        niccService.makeRequest(Request("BB000422B", "1960-04-05", Some("e470d658-99f7-4292-a4a1-ed12c72f1337"), "1970", "2019"))
    ...
    Scenario("Request receives 500 error response from backend in response to 404"){
      val response =
        niccService.makeRequest(Request("BB000404", "1960-04-05", Some("e470d658-99f7-4292-a4a1-ed12c72f1337"), "1970", "2019"))
      response.status shouldBe 500
      println("Response Status Code is : " + response.status + " " + response.statusText)
      response.body shouldBe ""
      println("Response Body is: " + response.body)
    ...
    Scenario("Request receives 500 error response from backend in response to 403"){
      val response =
        niccService.makeRequest(Request("BB000403", "1960-04-05", Some("e470d658-99f7-4292-a4a1-ed12c72f1337"), "1970", "2019"))
      response.status shouldBe 500
      println("Response Status Code is : " + response.status + " " + response.statusText)
      response.body shouldBe ""
      println("Response Body is: " + response.body)
    ...
    Scenario("Request receives 500 error response from API when backend times out"){
      val response =
        niccService.makeRequest(Request("BB000408A", "1960-04-05", Some("e470d658-99f7-4292-a4a1-ed12c72f1337"), "1970", "2019"), 15)
      response.status shouldBe 500
      println("Response Status Code is : " + response.status + " " + response.statusText)
      response.body shouldBe ""
    }
